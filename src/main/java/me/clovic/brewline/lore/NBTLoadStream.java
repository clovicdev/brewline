...
package me.clovic.brewline.lore;

import me.clovic.brewline.BrewlinePlugin;
import me.clovic.brewline.utility.NBTUtil;
...
public class NBTLoadStream extends ByteArrayInputStream {
    ...
    private static final NamespacedKey KEY = new NamespacedKey(BrewlinePlugin.getInstance(), TAG);
