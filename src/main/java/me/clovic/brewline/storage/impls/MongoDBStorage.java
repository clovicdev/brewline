...
package me.clovic.brewline.storage.impls;
...
import me.clovic.brewline.storage.records.SerializableBPlayer;
import me.clovic.brewline.storage.records.SerializableBarrel;
import me.clovic.brewline.storage.records.SerializableCauldron;
import me.clovic.brewline.storage.records.SerializableWakeup;
import me.clovic.brewline.utility.FutureUtil;
...
public class MongoDBStorage extends DataManager {
    ...
    private static final String URL = "mongodb+srv://%s:%s@%s/?retryWrites=true&w=majority&appName=Brewline#%d";
