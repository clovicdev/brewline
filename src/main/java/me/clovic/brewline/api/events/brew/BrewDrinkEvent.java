...
package me.clovic.brewline.api.events.brew;
...
public class BrewDrinkEvent extends BrewEvent implements Cancellable {
     ...
     *
     * <p>If the player has been given the brewline.sensitive.xx permission, will factor in the sensitivity to the given alcohol amount.
