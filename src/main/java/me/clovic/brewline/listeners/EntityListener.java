...
public class EntityListener implements Listener {
    ...
    public void onExplode(EntityExplodeEvent event) {
        ...
        while (iter.hasNext()) {
            ...
            if (barrel != null) {
                ...
                BrewlinePlugin.getInstance().getServer().getPluginManager().callEvent(breakEvent);
    ...
    private boolean causedByWindCharge(EntityExplodeEvent event) {
        ...
        if (!BrewlinePlugin.getMCVersion().isOrLater(MinecraftVersion.V1_21)) return false;
