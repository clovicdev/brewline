...
import me.clovic.brewline.utility.ItemMetaCompat;
...
public class CustomItem extends RecipeItem implements Ingredient {
    ...
    public CustomItem(ItemStack item) {
        ...
        if (itemMeta.hasDisplayName()) {
            ...
            name = ItemMetaCompat.getItemName(itemMeta);
        }
        if (itemMeta.hasLore()) {
    ...
    public static void registerItemLoader(BrewlinePlugin breweryPlugin) {
