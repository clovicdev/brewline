...
import me.clovic.brewline.BarrelWoodType;
import me.clovic.brewline.Brew;
import me.clovic.brewline.BrewlinePlugin;
import me.clovic.brewline.Translatable;
import me.clovic.brewline.configuration.ConfigManager;
import me.clovic.brewline.configuration.files.CustomItemsFile;
...
import me.clovic.brewline.utility.StringParser;
...
//		}
    ...
    private void scheduleCommand(Player player, String cmd, String playerName, int quality, boolean isServerCommand) {
        ...
        if (cmd.contains("/")) {
            ...
            if (delayTicks > 0) {
                ...
                }.runTaskLater(BrewlinePlugin.getInstance(), delayTicks);
                return;
            }
        }
    ...
    private void executeCommand(Player player, String cmd, String playerName, int quality, boolean isServerCommand) {
        ...
        BrewlinePlugin.getScheduler().execute(() -> {
                if (isServerCommand) {
