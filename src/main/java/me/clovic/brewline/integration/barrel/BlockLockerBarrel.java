...
package me.clovic.brewline.integration.barrel;

import me.clovic.brewline.Barrel;
import me.clovic.brewline.BarrelAsset;
import me.clovic.brewline.BarrelBody;
...
public class BlockLockerBarrel implements ProtectableBlocksSettings {
    ...
    public boolean isOrWillCreateBarrel(Block block) {
        if (!BrewlinePlugin.getInstance().isEnabled() || !BlockLockerHook.BLOCKLOCKER.isEnabled()) {
            return false;
        }
