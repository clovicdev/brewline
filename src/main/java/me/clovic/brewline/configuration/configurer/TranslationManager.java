...
package me.clovic.brewline.configuration.configurer;

import me.clovic.brewline.BrewlinePlugin;
import me.clovic.brewline.configuration.ConfigHead;
...
public class TranslationManager {
    ...
    private Lang loadFromResources(ConfigHead tempHead, Translation translation) {
        ...
        try (InputStream inputStream = BrewlinePlugin.class.getResourceAsStream("/" + langFilePathStr)) {
    ...
    public static TranslationManager getInstance() {
        if (singleton == null) {
            singleton = new TranslationManager(BrewlinePlugin.getInstance().getDataFolder());
        }
        return singleton;
    }
}
